...
export default function ServicesSection({ onNavigate }) {
  ...
  return (
    <section
      className="relative pt-8 pb-12 overflow-hidden bg-gradient-to-b"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-r from-indigo-100/40 via-purple-100/30 to-transparent rounded-full blur-[100px]" />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 px-6 py-3 mb-6 bg-white/80 backdrop-blur-xl rounded-full border border-slate-200 shadow-sm">
          ...
          <h2 className="
            ...
            text-slate-900
          ">
            <span className="block text-5xl md:text-7xl lg:text-8xl font-light leading-tight mb-2">
            ...
            <span className="block text-3xl md:text-4xl text-slate-500 font-light tracking-wide">
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-full bg-white/70 backdrop-blur-2xl rounded-[2rem] p-8 border border-slate-200/60 overflow-hidden transition-all duration-700 group-hover:bg-white/90 group-hover:border-slate-300/80 group-hover:-translate-y-2 group-hover:shadow-xl group-hover:shadow-slate-200/50">
                  ...
                  <div className="relative space-y-5">
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.iconBg} flex items-center justify-center flex-shrink-0 transition-all duration-500 shadow-sm`}
                      >
                        <Icon
                    ...
                    <div className="flex items-center gap-2 pt-2">
                      <span
                        className={`text-sm font-medium bg-gradient-to-r ${service.gradient} bg-clip-text text-transparent transition-all duration-300 ${
        ...
        <div className="text-center relative pt-8">
          <button
            onClick={() => onNavigate("services")}
            className="group relative inline-flex items-center gap-3 px-10 py-5 bg-white/80 backdrop-blur-xl rounded-full border border-slate-300 overflow-hidden transition-all duration-500 hover:bg-white hover:border-slate-400 hover:shadow-lg hover:shadow-slate-200/50 hover:-translate-y-1"
          >
