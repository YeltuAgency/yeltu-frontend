...
export default function AppStoreOptimizationPage() {
  ...
  const featureCards = [
    {
      id: "keywords",
      icon: Search,
      titleKey: "aso.features.keywords.title",
      descKey: "aso.features.keywords.desc",
    },
    {
      id: "listing",
      icon: LayoutTemplate,
      titleKey: "aso.features.listing.title",
      descKey: "aso.features.listing.desc",
    },
    {
      id: "visuals",
      icon: PenTool,
      titleKey: "aso.features.visuals.title",
      descKey: "aso.features.visuals.desc",
    },
    {
      id: "reviews",
      icon: Star,
      titleKey: "aso.features.reviews.title",
      descKey: "aso.features.reviews.desc",
    },
    {
      id: "engagement",
      icon: BarChart3,
      titleKey: "aso.features.engagement.title",
      descKey: "aso.features.engagement.desc",
    },
    {
      id: "optimization",
      icon: Zap,
      titleKey: "aso.features.optimization.title",
      descKey: "aso.features.optimization.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "aso.process.step1.title",
      descKey: "aso.process.step1.desc",
    },
    {
      icon: LayoutTemplate,
      titleKey: "aso.process.step2.title",
      descKey: "aso.process.step2.desc",
    },
    {
      icon: PenTool,
      titleKey: "aso.process.step3.title",
      descKey: "aso.process.step3.desc",
    },
    {
      icon: BarChart3,
      titleKey: "aso.process.step4.title",
      descKey: "aso.process.step4.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "aso.process.step5.title",
      descKey: "aso.process.step5.desc",
    },
  ];
  ...
  const solutions = {
    mobileapp: {
      ...
      titleKey: "aso.solutions.mobileapp.title",
      descKey: "aso.solutions.mobileapp.desc",
      link: "/services/mobile-app-development",
      image: mobileAppImg,
    },
    iosandroid: {
      icon: Smartphone,
      titleKey: "aso.solutions.iosandroid.title",
      descKey: "aso.solutions.iosandroid.desc",
      link: "/services/mobile-app-development/ios-android-app-development",
      image: iosAndroidImg,
    },
    crossplatform: {
      icon: Layers3,
      titleKey: "aso.solutions.crossplatform.title",
      descKey: "aso.solutions.crossplatform.desc",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO
        title={t("aso.seo.title")}
        description={t("aso.seo.desc")}
      />
          ...
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <div className="flex flex-col gap-4 fade-in-5">
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                ...
                {t("aso.hero.points.visibility")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("aso.hero.points.downloads")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("aso.hero.points.conversion")}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              {t("aso.solutions.title")}
            </h2>
            <p className="text-slate-600 mt-4 text-lg">
              {t("aso.solutions.subtitle")}
            </p>
          </div>
