...
export default function CrossPlatformAppDevelopmentPage() {
  ...
  const featureCards = [
    {
      id: "codebase",
      icon: Code,
      titleKey: "crossplatform.features.codebase.title",
      descKey: "crossplatform.features.codebase.desc",
    },
    {
      id: "ux",
      icon: LayoutTemplate,
      titleKey: "crossplatform.features.ux.title",
      descKey: "crossplatform.features.ux.desc",
    },
    {
      id: "speed",
      icon: Zap,
      titleKey: "crossplatform.features.speed.title",
      descKey: "crossplatform.features.speed.desc",
    },
    {
      id: "backend",
      icon: Database,
      titleKey: "crossplatform.features.backend.title",
      descKey: "crossplatform.features.backend.desc",
    },
    {
      id: "scalable",
      icon: Smartphone,
      titleKey: "crossplatform.features.scalable.title",
      descKey: "crossplatform.features.scalable.desc",
    },
    {
      id: "maintenance",
      icon: Wrench,
      titleKey: "crossplatform.features.maintenance.title",
      descKey: "crossplatform.features.maintenance.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "crossplatform.process.step1.title",
      descKey: "crossplatform.process.step1.desc",
    },
    {
      icon: LayoutTemplate,
      titleKey: "crossplatform.process.step2.title",
      descKey: "crossplatform.process.step2.desc",
    },
    {
      icon: PenTool,
      titleKey: "crossplatform.process.step3.title",
      descKey: "crossplatform.process.step3.desc",
    },
    {
      icon: Code,
      titleKey: "crossplatform.process.step4.title",
      descKey: "crossplatform.process.step4.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "crossplatform.process.step5.title",
      descKey: "crossplatform.process.step5.desc",
    },
  ];
  ...
  const solutions = {
    mobileapp: {
      ...
      titleKey: "crossplatform.solutions.mobileapp.title",
      descKey: "crossplatform.solutions.mobileapp.desc",
      link: "/services/mobile-app-development",
      image: mobileAppImg,
    },
    iosandroid: {
      icon: Smartphone,
      titleKey: "crossplatform.solutions.iosandroid.title",
      descKey: "crossplatform.solutions.iosandroid.desc",
      link: "/services/mobile-app-development/ios-android-app-development",
      image: iosAndroidImg,
    },
    aso: {
      icon: Store,
      titleKey: "crossplatform.solutions.aso.title",
      descKey: "crossplatform.solutions.aso.desc",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO
        title={t("crossplatform.seo.title")}
        description={t("crossplatform.seo.desc")}
      />
          ...
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <div className="flex flex-col gap-4 fade-in-5">
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                ...
                {t("crossplatform.hero.points.speed")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("crossplatform.hero.points.experience")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("crossplatform.hero.points.scaling")}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 space-y-6">
            <p className="text-lg text-slate-600 leading-relaxed">
              {t("crossplatform.intro.p1")}
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
              {t("crossplatform.intro.p2")}
            </p>
          </div>
      ...
      <section className="py-24 pt-10 pb-12 bg-slate-50 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 md:px-8 mb-12 flex justify-between items-end">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight max-w-2xl leading-tight">
            {t("crossplatform.features.title")}
          </h2>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              {t("crossplatform.process.title")}
            </h2>
            <p className="text-slate-400 text-lg">
              {t("crossplatform.process.subtitle")}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              {t("crossplatform.solutions.title")}
            </h2>
            <p className="text-slate-600 mt-4 text-lg">
              {t("crossplatform.solutions.subtitle")}
            </p>
          </div>
          ...
          <div key={activeTab} className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <div className="pt-4">
                ...
                >
                  {t("crossplatform.solutions.learnMore")}
