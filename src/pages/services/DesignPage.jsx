...
export default function DesignPage() {
  ...
  const featureCards = [
    {
      id: "identity",
      icon: BadgeCheck,
      titleKey: "design.features.identity.title",
      descKey: "design.features.identity.desc",
    },
    {
      id: "marketing",
      icon: Megaphone,
      titleKey: "design.features.marketing.title",
      descKey: "design.features.marketing.desc",
    },
    {
      id: "uiux",
      icon: LayoutTemplate,
      titleKey: "design.features.uiux.title",
      descKey: "design.features.uiux.desc",
    },
    {
      id: "photography",
      icon: Image,
      titleKey: "design.features.photography.title",
      descKey: "design.features.photography.desc",
    },
    {
      id: "motion",
      icon: Clapperboard,
      titleKey: "design.features.motion.title",
      descKey: "design.features.motion.desc",
    },
    {
      id: "video3d",
      icon: Box,
      titleKey: "design.features.video3d.title",
      descKey: "design.features.video3d.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "design.process.step1.title",
      descKey: "design.process.step1.desc",
    },
    {
      icon: PenTool,
      titleKey: "design.process.step2.title",
      descKey: "design.process.step2.desc",
    },
    {
      icon: Palette,
      titleKey: "design.process.step3.title",
      descKey: "design.process.step3.desc",
    },
    {
      icon: LayoutTemplate,
      titleKey: "design.process.step4.title",
      descKey: "design.process.step4.desc",
    },
    {
      icon: Clapperboard,
      titleKey: "design.process.step5.title",
      descKey: "design.process.step5.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "design.process.step6.title",
      descKey: "design.process.step6.desc",
    },
  ];
  ...
  const solutions = {
    digitalmarketing: {
      icon: BarChart3,
      titleKey: "design.solutions.digitalmarketing.title",
      descKey: "design.solutions.digitalmarketing.desc",
      ctaKey: "design.solutions.digitalmarketing.cta",
      link: "/services/digital-marketing",
      image: digitalMarketingImg,
    },
    seo: {
      icon: Search,
      titleKey: "design.solutions.seo.title",
      descKey: "design.solutions.seo.desc",
      ctaKey: "design.solutions.seo.cta",
      link: "/services/digital-marketing/seo",
      image: seoImg,
    },
    sem: {
      icon: Megaphone,
      titleKey: "design.solutions.sem.title",
      descKey: "design.solutions.sem.desc",
      ctaKey: "design.solutions.sem.cta",
      link: "/services/digital-marketing/sem",
      image: semImg,
    },
    smm: {
      icon: Share2,
      titleKey: "design.solutions.smm.title",
      descKey: "design.solutions.smm.desc",
      ctaKey: "design.solutions.smm.cta",
  ...
  const closingCards = [
    {
      titleKey: "design.closing.cards.vision.title",
      descKey: "design.closing.cards.vision.desc",
    },
    {
      titleKey: "design.closing.cards.visuals.title",
      descKey: "design.closing.cards.visuals.desc",
    },
    {
      titleKey: "design.closing.cards.campaigns.title",
      descKey: "design.closing.cards.campaigns.desc",
    },
    {
      titleKey: "design.closing.cards.consistency.title",
      descKey: "design.closing.cards.consistency.desc",
    },
  ];

  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO title={t("design.seo.title")} description={t("design.seo.desc")} />
          ...
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <div className="flex flex-col gap-4 fade-in-5">
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                ...
                {t("design.hero.points.identity")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("design.hero.points.marketing")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("design.hero.points.motion")}
              </div>
            </div>

            <div className="mt-14 fade-in-4">
              <Button
                aria-label="Start Your Creative Design Project"
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start z-10">
          <div className="space-y-8 lg:sticky lg:top-24">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight bg-gradient-to-br from-white to-slate-300 bg-clip-text text-transparent">
              {t("design.closing.title")}
            </h2>
            <div className="space-y-6 text-blue-100/80 text-lg leading-relaxed">
              <p>{t("design.closing.p1")}</p>
              <p>{t("design.closing.p2")}</p>
            </div>
