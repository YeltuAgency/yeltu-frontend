...
export default function DigitalMarketingPage() {
  ...
  const featureCards = [
    {
      id: "seo",
      icon: Search,
      titleKey: "digitalmarketing.features.seo.title",
      descKey: "digitalmarketing.features.seo.desc",
    },
    {
      id: "sem",
      icon: Megaphone,
      titleKey: "digitalmarketing.features.sem.title",
      descKey: "digitalmarketing.features.sem.desc",
    },
    {
      id: "smm",
      icon: Share2,
      titleKey: "digitalmarketing.features.smm.title",
      descKey: "digitalmarketing.features.smm.desc",
    },
    {
      id: "content",
      icon: FileText,
      titleKey: "digitalmarketing.features.content.title",
      descKey: "digitalmarketing.features.content.desc",
    },
    {
      id: "conversion",
      icon: Funnel,
      titleKey: "digitalmarketing.features.conversion.title",
      descKey: "digitalmarketing.features.conversion.desc",
    },
    {
      id: "audience",
      icon: Users,
      titleKey: "digitalmarketing.features.audience.title",
      descKey: "digitalmarketing.features.audience.desc",
    },
    {
      id: "analytics",
      icon: BarChart3,
      titleKey: "digitalmarketing.features.analytics.title",
      descKey: "digitalmarketing.features.analytics.desc",
    },
    {
      id: "positioning",
      icon: BadgeCheck,
      titleKey: "digitalmarketing.features.positioning.title",
      descKey: "digitalmarketing.features.positioning.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "digitalmarketing.process.step1.title",
      descKey: "digitalmarketing.process.step1.desc",
    },
    {
      icon: Users,
      titleKey: "digitalmarketing.process.step2.title",
      descKey: "digitalmarketing.process.step2.desc",
    },
    {
      icon: PenTool,
      titleKey: "digitalmarketing.process.step3.title",
      descKey: "digitalmarketing.process.step3.desc",
    },
    {
      icon: MousePointerClick,
      titleKey: "digitalmarketing.process.step4.title",
      descKey: "digitalmarketing.process.step4.desc",
    },
    {
      icon: LineChart,
      titleKey: "digitalmarketing.process.step5.title",
      descKey: "digitalmarketing.process.step5.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "digitalmarketing.process.step6.title",
      descKey: "digitalmarketing.process.step6.desc",
    },
  ];
  ...
  const solutions = {
    seo: {
      icon: Search,
      titleKey: "digitalmarketing.solutions.seo.title",
      descKey: "digitalmarketing.solutions.seo.desc",
      ctaKey: "digitalmarketing.solutions.seo.cta",
      link: "/services/digital-marketing/seo",
      image: seoImg,
    },
    sem: {
      icon: Megaphone,
      titleKey: "digitalmarketing.solutions.sem.title",
      descKey: "digitalmarketing.solutions.sem.desc",
      ctaKey: "digitalmarketing.solutions.sem.cta",
      link: "/services/digital-marketing/sem",
      image: semImg,
    },
    smm: {
      icon: Share2,
      titleKey: "digitalmarketing.solutions.smm.title",
      descKey: "digitalmarketing.solutions.smm.desc",
      ctaKey: "digitalmarketing.solutions.smm.cta",
      link: "/services/digital-marketing/smm",
      image: smmImg,
    },
    design: {
      icon: Palette,
      titleKey: "digitalmarketing.solutions.design.title",
      descKey: "digitalmarketing.solutions.design.desc",
      ctaKey: "digitalmarketing.solutions.design.cta",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO
        title={t("digitalmarketing.seo.title")}
        description={t("digitalmarketing.seo.desc")}
      />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 grid lg:grid-cols-2 gap-14 items-center w-full">
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <p className="mt-6 pb-6 text-lg text-blue-100 max-w-lg fade-in-3">
              {t("digitalmarketing.hero.hook")}
            </p>

            <div className="flex flex-col gap-4 fade-in-5">
              <Link
                to={withLang(solutions.seo.link)}
                className="group flex items-center gap-3 text-base font-medium text-slate-300 hover:text-white transition-colors w-fit"
              >
                <ArrowRight className="w-5 h-5 text-blue-400 group-hover:translate-x-1 transition-transform" />
                {t("digitalmarketing.hero.link.seo")}
              </Link>
              <Link
                to={withLang(solutions.sem.link)}
                className="group flex items-center gap-3 text-base font-medium text-slate-300 hover:text-white transition-colors w-fit"
              >
                <ArrowRight className="w-5 h-5 text-blue-400 group-hover:translate-x-1 transition-transform" />
                {t("digitalmarketing.hero.link.sem")}
              </Link>
              <Link
                to={withLang(solutions.smm.link)}
                className="group flex items-center gap-3 text-base font-medium text-slate-300 hover:text-white transition-colors w-fit"
              >
                <ArrowRight className="w-5 h-5 text-blue-400 group-hover:translate-x-1 transition-transform" />
                {t("digitalmarketing.hero.link.smm")}
              </Link>
              <Link
                to={withLang(solutions.design.link)}
                className="group flex items-center gap-3 text-base font-medium text-slate-300 hover:text-white transition-colors w-fit"
              >
                <ArrowRight className="w-5 h-5 text-blue-400 group-hover:translate-x-1 transition-transform" />
                {t("digitalmarketing.hero.link.design")}
              </Link>
            </div>

            <div className="mt-14 fade-in-4">
              <Button
                aria-label="Start Digital Marketing Strategy"
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent leading-tight lg:pl-10">
              {t("digitalmarketing.intro.title")}
            </h2>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 pt-10 pb-12 bg-slate-50 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 md:px-8 mb-12 flex justify-between items-end">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight max-w-2xl leading-tight">
            {t("digitalmarketing.features.title")}
          </h2>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className="order-1">
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent leading-tight lg:pr-10">
                {t("digitalmarketing.deepdive.h1.title")}
              </h1>
            </div>
            <div className="order-2 text-xl text-slate-600 leading-relaxed font-light">
              <p>{t("digitalmarketing.deepdive.h1.p1")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 4B. DEEP DIVE BLOCK 2 */}
      <section className="py-24 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className="order-2 lg:order-1 text-xl text-slate-600 leading-relaxed font-light">
              <p>{t("digitalmarketing.deepdive.h2.p1")}</p>
            </div>
            <div className="order-1 lg:order-2">
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent leading-tight lg:pl-10">
                {t("digitalmarketing.deepdive.h2.title")}
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-400 text-lg">
              {t("digitalmarketing.process.subtitle")}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              {t("digitalmarketing.solutions.title")}
            </h2>
            <p className="text-slate-600 mt-4 text-lg">
              {t("digitalmarketing.solutions.subtitle")}
            </p>
          </div>
