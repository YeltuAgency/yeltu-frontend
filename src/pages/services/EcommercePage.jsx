...
export default function EcommercePage() {
  ...
  const [activeTab, setActiveTab] = useState("customwebapp");
  ...
  const featureCards = [
    {
      id: "architecture",
      icon: LayoutTemplate,
      titleKey: "ecommerce.features.architecture.title",
      descKey: "ecommerce.features.architecture.desc",
    },
    {
      id: "integration",
      icon: Network,
      titleKey: "ecommerce.features.integration.title",
      descKey: "ecommerce.features.integration.desc",
    },
    {
      id: "uiux",
      icon: PenTool,
      titleKey: "ecommerce.features.uiux.title",
      descKey: "ecommerce.features.uiux.desc",
    },
    {
      id: "performance",
      icon: Zap,
      titleKey: "ecommerce.features.performance.title",
      descKey: "ecommerce.features.performance.desc",
    },
    {
      id: "security",
      icon: ShieldCheck,
      titleKey: "ecommerce.features.security.title",
      descKey: "ecommerce.features.security.desc",
    },
    {
      id: "scalable",
      icon: Database,
      titleKey: "ecommerce.features.scalable.title",
      descKey: "ecommerce.features.scalable.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "ecommerce.process.step1.title",
      descKey: "ecommerce.process.step1.desc",
    },
    {
      icon: LayoutTemplate,
      titleKey: "ecommerce.process.step2.title",
      descKey: "ecommerce.process.step2.desc",
    },
    {
      icon: PenTool,
      titleKey: "ecommerce.process.step3.title",
      descKey: "ecommerce.process.step3.desc",
    },
    {
      icon: Code,
      titleKey: "ecommerce.process.step4.title",
      descKey: "ecommerce.process.step4.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "ecommerce.process.step5.title",
      descKey: "ecommerce.process.step5.desc",
    },
  ];
  ...
  const solutions = {
    webdev: {
      ...
      titleKey: "ecommerce.solutions.webdev.title",
      descKey: "ecommerce.solutions.webdev.desc",
      link: "/services/web-development",
      image: webImg,
    },
    customwebapp: {
      icon: LayoutTemplate,
      titleKey: "ecommerce.solutions.customwebapp.title",
      descKey: "ecommerce.solutions.customwebapp.desc",
      link: "/services/web-development/custom-web-apps",
      image: customWebAppsImg,
    },
    business: {
      icon: Briefcase,
      titleKey: "ecommerce.solutions.business.title",
      descKey: "ecommerce.solutions.business.desc",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO
        title={t("ecommerce.seo.title")}
        description={t("ecommerce.seo.desc")}
      />
          ...
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <div className="flex flex-col gap-4 fade-in-5">
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                ...
                {t("ecommerce.hero.points.precision")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("ecommerce.hero.points.integration")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("ecommerce.hero.points.scale")}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 space-y-6">
            <p className="text-lg text-slate-600 leading-relaxed">
              {t("ecommerce.intro.p1")}
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
              {t("ecommerce.intro.p2")}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              {t("ecommerce.process.title")}
            </h2>
            <p className="text-slate-400 text-lg">
              {t("ecommerce.process.subtitle")}
            </p>
          </div>
          ...
          <div key={activeTab} className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <div className="pt-4">
                ...
                >
                  {t("ecommerce.solutions.learnMore")}
