...
export default function IosAndroidAppDevelopmentPage() {
  ...
  const featureCards = [
    {
      id: "performance",
      icon: Zap,
      titleKey: "iosandroid.features.performance.title",
      descKey: "iosandroid.features.performance.desc",
    },
    {
      id: "integration",
      icon: Smartphone,
      titleKey: "iosandroid.features.integration.title",
      descKey: "iosandroid.features.integration.desc",
    },
    {
      id: "uiux",
      icon: LayoutTemplate,
      titleKey: "iosandroid.features.uiux.title",
      descKey: "iosandroid.features.uiux.desc",
    },
    {
      id: "backend",
      icon: Database,
      titleKey: "iosandroid.features.backend.title",
      descKey: "iosandroid.features.backend.desc",
    },
    {
      id: "security",
      icon: ShieldCheck,
      titleKey: "iosandroid.features.security.title",
      descKey: "iosandroid.features.security.desc",
    },
    {
      id: "stability",
      icon: Wrench,
      titleKey: "iosandroid.features.stability.title",
      descKey: "iosandroid.features.stability.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "iosandroid.process.step1.title",
      descKey: "iosandroid.process.step1.desc",
    },
    {
      icon: LayoutTemplate,
      titleKey: "iosandroid.process.step2.title",
      descKey: "iosandroid.process.step2.desc",
    },
    {
      icon: PenTool,
      titleKey: "iosandroid.process.step3.title",
      descKey: "iosandroid.process.step3.desc",
    },
    {
      icon: Code,
      titleKey: "iosandroid.process.step4.title",
      descKey: "iosandroid.process.step4.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "iosandroid.process.step5.title",
      descKey: "iosandroid.process.step5.desc",
    },
  ];
  ...
  const solutions = {
    mobileapp: {
      ...
      titleKey: "iosandroid.solutions.mobileapp.title",
      descKey: "iosandroid.solutions.mobileapp.desc",
      link: "/services/mobile-app-development",
      image: mobileAppImg,
    },
    crossplatform: {
      icon: Layers3,
      titleKey: "iosandroid.solutions.crossplatform.title",
      descKey: "iosandroid.solutions.crossplatform.desc",
      link: "/services/mobile-app-development/cross-platform-app-development",
      image: crossPlatformImg,
    },
    aso: {
      icon: Store,
      titleKey: "iosandroid.solutions.aso.title",
      descKey: "iosandroid.solutions.aso.desc",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO
        title={t("iosandroid.seo.title")}
        description={t("iosandroid.seo.desc")}
      />
          ...
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <div className="flex flex-col gap-4 fade-in-5">
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                ...
                {t("iosandroid.hero.points.performance")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("iosandroid.hero.points.experience")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("iosandroid.hero.points.architecture")}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 space-y-6">
            <p className="text-lg text-slate-600 leading-relaxed">
              {t("iosandroid.intro.p1")}
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
              {t("iosandroid.intro.p2")}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              {t("iosandroid.process.title")}
            </h2>
            <p className="text-slate-400 text-lg">
              {t("iosandroid.process.subtitle")}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              {t("iosandroid.solutions.title")}
            </h2>
            <p className="text-slate-600 mt-4 text-lg">
              {t("iosandroid.solutions.subtitle")}
            </p>
          </div>
          ...
          <div key={activeTab} className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <div className="pt-4">
                ...
                >
                  {t("iosandroid.solutions.learnMore")}
