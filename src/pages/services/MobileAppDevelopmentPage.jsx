...
import mobileAppImg from "../../assets/services/mobileapp.webp";
import iosAndroidImg from "../../assets/services/ios-android.webp";
import crossPlatformImg from "../../assets/services/cross-platform.webp";
import asoImg from "../../assets/services/app-store-optimization.webp";
import {
  ArrowRight,
  X,
  LayoutTemplate,
...
export default function MobileAppDevelopmentPage() {
  ...
  const [activeTab, setActiveTab] = useState("iosandroid");
  ...
  const featureCards = [
    {
      id: "uiux",
      icon: LayoutTemplate,
      titleKey: "mobileapp.features.uiux.title",
      descKey: "mobileapp.features.uiux.desc",
    },
    {
      id: "architecture",
      icon: Zap,
      titleKey: "mobileapp.features.architecture.title",
      descKey: "mobileapp.features.architecture.desc",
    },
    {
      id: "crossplatform",
      icon: Smartphone,
      titleKey: "mobileapp.features.crossplatform.title",
      descKey: "mobileapp.features.crossplatform.desc",
    },
    {
      id: "backend",
      icon: Database,
      titleKey: "mobileapp.features.backend.title",
      descKey: "mobileapp.features.backend.desc",
    },
    {
      id: "security",
      icon: ShieldCheck,
      titleKey: "mobileapp.features.security.title",
      descKey: "mobileapp.features.security.desc",
    },
    {
      id: "maintenance",
      icon: Wrench,
      titleKey: "mobileapp.features.maintenance.title",
      descKey: "mobileapp.features.maintenance.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "mobileapp.process.step1.title",
      descKey: "mobileapp.process.step1.desc",
    },
    {
      icon: LayoutTemplate,
      titleKey: "mobileapp.process.step2.title",
      descKey: "mobileapp.process.step2.desc",
    },
    {
      icon: PenTool,
      titleKey: "mobileapp.process.step3.title",
      descKey: "mobileapp.process.step3.desc",
    },
    {
      icon: Code,
      titleKey: "mobileapp.process.step4.title",
      descKey: "mobileapp.process.step4.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "mobileapp.process.step5.title",
      descKey: "mobileapp.process.step5.desc",
    },
  ];
  ...
  const solutions = {
    iosandroid: {
      ...
      titleKey: "mobileapp.solutions.iosandroid.title",
      descKey: "mobileapp.solutions.iosandroid.desc",
      link: "/services/mobile-app-development/ios-android-app-development",
      image: iosAndroidImg,
    },
    crossplatform: {
      icon: Layers3,
      titleKey: "mobileapp.solutions.crossplatform.title",
      descKey: "mobileapp.solutions.crossplatform.desc",
      link: "/services/mobile-app-development/cross-platform-app-development",
      image: crossPlatformImg,
    },
    aso: {
      icon: Store,
      titleKey: "mobileapp.solutions.aso.title",
      descKey: "mobileapp.solutions.aso.desc",
      link: "/services/mobile-app-development/app-store-optimization",
      image: asoImg,
    },
  };
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO
        title={t("mobileapp.seo.title")}
        description={t("mobileapp.seo.desc")}
      />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 grid lg:grid-cols-2 gap-14 items-center w-full">
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <p className="mt-6 pb-6 text-lg text-blue-100 max-w-lg fade-in-3">
              {t("mobileapp.hero.hook")}
            </p>

            <div className="flex flex-col gap-4 fade-in-5">
              <Link
                to={withLang(solutions.iosandroid.link)}
              ...
              >
                ...
                {t("mobileapp.hero.link.iosandroid")}
              </Link>
              <Link
                to={withLang(solutions.crossplatform.link)}
                className="group flex items-center gap-3 text-base font-medium text-slate-300 hover:text-white transition-colors w-fit"
              >
                <ArrowRight className="w-5 h-5 text-blue-400 group-hover:translate-x-1 transition-transform" />
                {t("mobileapp.hero.link.crossplatform")}
              </Link>
              <Link
                to={withLang(solutions.aso.link)}
                className="group flex items-center gap-3 text-base font-medium text-slate-300 hover:text-white transition-colors w-fit"
              >
                <ArrowRight className="w-5 h-5 text-blue-400 group-hover:translate-x-1 transition-transform" />
                {t("mobileapp.hero.link.aso")}
              </Link>
            </div>
      ...
      {/* 6. MOBILE DEVELOPMENT WE SPECIALIZE IN */}
      <section className="py-24 pt-14 pb-16 bg-white px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              {t("mobileapp.solutions.title")}
            </h2>
            <p className="text-slate-600 mt-4 text-lg">
              {t("mobileapp.solutions.subtitle")}
            </p>
          </div>
          ...
          <div key={activeTab} className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <div className="pt-4">
                ...
                >
                  {t("mobileapp.solutions.learnMore")}
