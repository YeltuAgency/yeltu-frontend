...
export default function SeoPage() {
  ...
  const featureCards = [
    {
      id: "technical",
      icon: Search,
      titleKey: "seo.features.technical.title",
      descKey: "seo.features.technical.desc",
    },
    {
      id: "keywords",
      icon: FileSearch,
      titleKey: "seo.features.keywords.title",
      descKey: "seo.features.keywords.desc",
    },
    {
      id: "onpage",
      icon: LayoutTemplate,
      titleKey: "seo.features.onpage.title",
      descKey: "seo.features.onpage.desc",
    },
    {
      id: "content",
      icon: FileText,
      titleKey: "seo.features.content.title",
      descKey: "seo.features.content.desc",
    },
    {
      id: "links",
      icon: Link2,
      titleKey: "seo.features.links.title",
      descKey: "seo.features.links.desc",
    },
    {
      id: "monitoring",
      icon: LineChart,
      titleKey: "seo.features.monitoring.title",
      descKey: "seo.features.monitoring.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Search,
      titleKey: "seo.process.step1.title",
      descKey: "seo.process.step1.desc",
    },
    {
      icon: FileSearch,
      titleKey: "seo.process.step2.title",
      descKey: "seo.process.step2.desc",
    },
    {
      icon: LayoutTemplate,
      titleKey: "seo.process.step3.title",
      descKey: "seo.process.step3.desc",
    },
    {
      icon: PenTool,
      titleKey: "seo.process.step4.title",
      descKey: "seo.process.step4.desc",
    },
    {
      icon: Link2,
      titleKey: "seo.process.step5.title",
      descKey: "seo.process.step5.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "seo.process.step6.title",
      descKey: "seo.process.step6.desc",
    },
  ];
  ...
  const solutions = {
    digitalmarketing: {
      icon: BarChart3,
      titleKey: "seo.solutions.digitalmarketing.title",
      descKey: "seo.solutions.digitalmarketing.desc",
      ctaKey: "seo.solutions.digitalmarketing.cta",
      link: "/services/digital-marketing",
      image: digitalMarketingImg,
    },
    sem: {
      icon: Megaphone,
      titleKey: "seo.solutions.sem.title",
      descKey: "seo.solutions.sem.desc",
      ctaKey: "seo.solutions.sem.cta",
      link: "/services/digital-marketing/sem",
      image: semImg,
    },
    smm: {
      icon: Share2,
      titleKey: "seo.solutions.smm.title",
      descKey: "seo.solutions.smm.desc",
      ctaKey: "seo.solutions.smm.cta",
      link: "/services/digital-marketing/smm",
      image: smmImg,
    },
    design: {
      icon: Palette,
      titleKey: "seo.solutions.design.title",
      descKey: "seo.solutions.design.desc",
      ctaKey: "seo.solutions.design.cta",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO title={t("seo.seo.title")} description={t("seo.seo.desc")} />
          ...
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <div className="flex flex-col gap-4 fade-in-5">
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                ...
                {t("seo.hero.points.technical")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("seo.hero.points.onpage")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("seo.hero.points.content")}
              </div>
            </div>

            <div className="mt-14 fade-in-4">
              <Button
                aria-label="Start Your SEO Strategy"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              {t("seo.solutions.title")}
            </h2>
            <p className="text-slate-600 mt-4 text-lg">
              {t("seo.solutions.subtitle")}
            </p>
          </div>
