...
export default function SmmPage() {
  ...
  const featureCards = [
    {
      id: "strategy",
      icon: Users,
      titleKey: "smm.features.strategy.title",
      descKey: "smm.features.strategy.desc",
    },
    {
      id: "planning",
      icon: FileText,
      titleKey: "smm.features.planning.title",
      descKey: "smm.features.planning.desc",
    },
    {
      id: "engagement",
      icon: MessageCircle,
      titleKey: "smm.features.engagement.title",
      descKey: "smm.features.engagement.desc",
    },
    {
      id: "paid",
      icon: Megaphone,
      titleKey: "smm.features.paid.title",
      descKey: "smm.features.paid.desc",
    },
    {
      id: "communication",
      icon: BadgeCheck,
      titleKey: "smm.features.communication.title",
      descKey: "smm.features.communication.desc",
    },
    {
      id: "insights",
      icon: LineChart,
      titleKey: "smm.features.insights.title",
      descKey: "smm.features.insights.desc",
    },
  ];
  ...
  const processSteps = [
    {
      icon: Users,
      titleKey: "smm.process.step1.title",
      descKey: "smm.process.step1.desc",
    },
    {
      icon: PenTool,
      titleKey: "smm.process.step2.title",
      descKey: "smm.process.step2.desc",
    },
    {
      icon: FileText,
      titleKey: "smm.process.step3.title",
      descKey: "smm.process.step3.desc",
    },
    {
      icon: MousePointerClick,
      titleKey: "smm.process.step4.title",
      descKey: "smm.process.step4.desc",
    },
    {
      icon: LineChart,
      titleKey: "smm.process.step5.title",
      descKey: "smm.process.step5.desc",
    },
    {
      icon: CheckCircle,
      titleKey: "smm.process.step6.title",
      descKey: "smm.process.step6.desc",
    },
  ];
  ...
  const solutions = {
    digitalmarketing: {
      icon: BarChart3,
      titleKey: "smm.solutions.digitalmarketing.title",
      descKey: "smm.solutions.digitalmarketing.desc",
      ctaKey: "smm.solutions.digitalmarketing.cta",
      link: "/services/digital-marketing",
      image: digitalMarketingImg,
    },
    seo: {
      icon: Search,
      titleKey: "smm.solutions.seo.title",
      descKey: "smm.solutions.seo.desc",
      ctaKey: "smm.solutions.seo.cta",
      link: "/services/digital-marketing/seo",
      image: seoImg,
    },
    sem: {
      icon: Megaphone,
      titleKey: "smm.solutions.sem.title",
      descKey: "smm.solutions.sem.desc",
      ctaKey: "smm.solutions.sem.cta",
      link: "/services/digital-marketing/sem",
      image: semImg,
    },
    design: {
      icon: Palette,
      titleKey: "smm.solutions.design.title",
      descKey: "smm.solutions.design.desc",
      ctaKey: "smm.solutions.design.cta",
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden font-sans">
      <SEO title={t("smm.seo.title")} description={t("smm.seo.desc")} />
          ...
          <div className="z-10 flex flex-col h-full justify-center lg:pl-8">
            ...
            <div className="flex flex-col gap-4 fade-in-5">
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                ...
                {t("smm.hero.points.strategy")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("smm.hero.points.content")}
              </div>
              <div className="flex items-center gap-3 text-base font-medium text-slate-300">
                <ArrowRight className="w-5 h-5 text-blue-400" />
                {t("smm.hero.points.paid")}
              </div>
            </div>

            <div className="mt-14 fade-in-4">
              <Button
                aria-label="Start Your Social Media Strategy"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
              {t("smm.solutions.title")}
            </h2>
            <p className="text-slate-600 mt-4 text-lg">
              {t("smm.solutions.subtitle")}
            </p>
          </div>
